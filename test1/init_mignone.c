...
static double MACH=2.711227;
static double LORENTZ=7.08881205008335;
static double RHOJ =0.1;
static double RHOA=10.0;
static double SIGMA_POL =0.51;
static double SIGMA_TOR=0.0;
static double pj;
